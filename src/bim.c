...
bim_t *bim_read(const char *bimfile, size_t *nl)
{
    size_t lines_read;
...
int bim_write(const char *outfile, const bim_t *bim, const size_t nl)
{
    size_t i = 0;
    FILE *fout = NULL;
...
khash_t(integer) *bim_index(const bim_t *bim, const size_t nl)
{
    int a = 0;
    size_t i = 0;
    khint_t k = 0;
...
void bim_destroy(bim_t *bim, const size_t nsnp)
{
    size_t i = 0;
