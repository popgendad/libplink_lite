...
reg_t *reg_read(const char *regfile, size_t *nl)
{
    size_t lines_read = 0;
...
int reg_write(const char *outfile, const reg_t *reg, const size_t nl)
{
    size_t i = 0;
    FILE *fout = NULL;
...
khash_t(integer) *reg_index(const reg_t *reg, const size_t nl)
{
    int a = 0;
    size_t i = 0;
    khint_t k = 0;
...
void reg_destroy(reg_t *reg, const size_t nsam)
{
    size_t i = 0;
